...
<body>
    ...
    <div class="card">
        <h3>Total de O.S</h3>
        <p><?php echo count($oss); // Displays the total number of O.S ?></p>
    </div>
    <div class="card">
        <h3>Total de P.F</h3>
        <p><?php echo array_sum(array_column($oss, 'Apf')); // Sum of all APF values ?></p>
    </div>
    <div class="card">
        <h3>Valor Total</h3>
        <p><?php echo 'R$ ' . number_format(array_sum(array_column($oss, 'Valor')), 2, ',', '.'); // Sum of all 'Valor' values formatted as currency ?></p>
    </div>
</div>
