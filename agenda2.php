...
$perfisPermitidos = [1]; // Exemplo: somente Admin, Gestor e Inova podem acessar
...
.linha-taxada {
  ...
  <body>    
    ...
    <div id="calendar"></div> <!-- Contêiner para o FullCalendar -->
</div>


<div class="modal fade" id="calendar-events" tabindex="-1" role="dialog">
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control" id="start" name="inicio">
    </div>
    <div class="form-group">
        <label for="end">Data de Fim</label>
        <input type="date" class="form-control" id="end" name="fim">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" id="description" name="descricao"></textarea>
    </div>
    <!-- Botões e outros campos conforme necessário -->
</form>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        plugins: ['dayGrid'], // Garanta que você tenha ativado os plugins necessários.
        initialView: 'dayGridMonth',
        events: 'events.php', // Caminho para o script PHP que retorna eventos.
