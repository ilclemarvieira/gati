                ...
                <div class="row justify-content-center text-center">
                    <div class="col-md-7 col-lg-12 col-xl-9">
                        ...
                        <p class="fs-4 mt-4" style="color: #ccccccd6">
                            Transforme a gestão de TI com o GATI. Conecte sua equipe, otimize operações e acelere a execução de projetos. Tudo o que você precisa, em um lugar só, para elevar a eficiência ao próximo nível.
                        </p>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form-horizontal mt-4 pt-4 needs-validation" novalidate method="post" action="process_login.php">
                               <div class="form-floating mb-3">
                                  <input type="text" class="form-control form-input-bg" id="cpf" name="cpf" placeholder="CPF" maxlength="14" required>
