      ...
      <div class="page-wrapper">
        ...
        <div class="row page-titles">
          <div class="col-md-5 col-12 align-self-center">
            <h3 class="text-themecolor mb-0"><i class="mdi mdi-book"></i> Contratadas</h3>            
          </div>          
        </div>
...
<!-- Botão para abrir o modal de adicionar nova OS -->
        <button class="btn waves-effect waves-light btn-info" onclick="openModal('addModal')"><i class="ti-plus text"></i> Cadastrar Contratada</button>
    ...
    <?php foreach ($contratadas as $contratada): ?>
        <tr>
            ...
            <td style="text-align: center; vertical-align: middle">
                <?php echo htmlspecialchars($contratada['E_mail']); ?>
            </td>
            
            <td style="text-align: center; vertical-align: middle" class="action-buttons">
    <div class="d-flex justify-content-center align-items-center">
        <!-- Botão Editar com ícone de lápis -->
        <button onclick="loadEditModal(<?php echo $contratada['Id'] . ', \'' . addslashes($contratada['Nome']) . '\', \'' . addslashes($contratada['E_mail']) . '\''; ?>)" title="Editar" class="btn btn-sm btn-light-info text-white mx-1">
            <i data-feather="edit" class="feather-sm fill-white"></i>
        </button>

        <!-- Botão Excluir com ícone de lixeira -->
        <button onclick="deleteContracted(<?php echo $contratada['Id']; ?>)" title="Excluir" class="btn btn-sm btn-light-danger text-white mx-1">
        ...
        <div class="modal-content bg-dark text-white">
            <div class="modal-header">
                <h2 class="modal-title" id="modalCadastroLabel">
                    <i class="mdi mdi-account-plus"></i>&nbsp;Cadastrar Contratada
                </h2>
                <span class="close" onclick="closeModal('addModal')">&times;</span>
            </div>
            <form id="addContratadaForm" action="process_cadastro.php" method="post" onsubmit="event.preventDefault(); submitAddForm();">
                <div class="modal-body">
                    <!-- Campos para a inserção de dados -->
                    <div class="mb-3">
                        <label for="addNome" class="form-label">Nome:</label>
                        <input type="text" class="form-control bg-secondary text-white" id="addNome" name="nome" required>
                    </div>
                    <div class="mb-3">
                        <label for="addEmail" class="form-label">E-mail:</label>
                        <input type="email" class="form-control bg-secondary text-white" id="addEmail" name="email" required>
                    </div>
                    <!-- Botão de submissão -->
