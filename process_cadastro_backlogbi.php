...
$stmt = $pdo->prepare("SELECT * FROM backlogbi WHERE Projeto = ? AND Descricao = ?");
...
$stmt = $pdo->prepare("INSERT INTO backlogbi (Projeto, Dt_criacao, Prioridade, Status_ideia, Responsavel, Encaminhado_os, Descricao, Anexo) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
